...
plt.text(0.5, -0.15, 
         "Citra gelap (under exposed). \nKomponen histogram terkonsentrasi pada nilai-nilai grayscale yang rendah (menumpuk pada sisi histogram sebelah kiri).",
         ha="center", va="top", fontsize=12, wrap=True, transform=plt.gca().transAxes)
